...
\title{Rectangular Statistical Cartograms in \proglang{R}: The \pkg{recmap} Package}
...
dir.create("graphics")
message("This manuscript requires the R packages: recmap (>=0.5.27), maps, noncensus.")
message(paste("recmap version", packageVersion('recmap'), "is used."))


stopifnot(packageVersion('recmap') >= '0.5.27')
...
load(file.path(path.package(package = "recmap"),
                 file.path("extdata", "recmap_JSS2711.RData")))
