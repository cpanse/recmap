...
Z <- recmapGA(checkerboard(8), maxiter = 1)$Summary

xt <- xtable(do.call('rbind', list(Z,X,Y)), caption = "\\label{tab:summary}The table lists a Summary of the X77 and U.S. county level examples.")
print(xt,
