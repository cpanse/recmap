...
A *local placement* function can place an rectangle A (rainbow colored rectangles) around a given rectangle B  
...
```{r echo=FALSE, fig.width=4, fig.height=3, fig.align='center', fig.retina=3}
...
op <- par(mar=c(5, 5, 0.5, 0.5))
plot(0,0 , 
     xlim=c(-35,25), ylim=c(-35,25), 
     asp=1, xlab='x', ylab='y', axes=FALSE); abline(v=0,h=0)
