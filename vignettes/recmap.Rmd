...
The desired area $\tilde{A_j}$ of a map region  $r_j = (x_j, y_j, dx_j, dy_j, z_j)$ is defined as
$$\tilde{A_j}= z_j \cdot \frac {4 \cdot \sum_{i=1}^{n}dx_i \cdot dy_i} {\sum_{i=1}^{n} z_{i}}$$ 
