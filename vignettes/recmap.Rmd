...
regions) by placing it next to a neighbour
...
>>>>>>> 9049dc3109db66fddaf479cafdfbff1507b0adcc
...
More examples using `state.x77` data and `shiny` application are available on [shinyapps.io](https://recmap.shinyapps.io/state_x77/).
