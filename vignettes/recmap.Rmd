...
```{r fig.width=7, fig.height=3.5, fig.align='center', fig.retina=2, fig.cap="chess board fun (left input; right output of `recmap`) - the area of a black box needs to be four times as large as the area of a white box."}
