...
```{r fig.width=8, fig.height=4, fig.align='left', fig.cap="Area ~ population estimate as of July 1, 1975; a better index order has been choosen to minimize the relative position error."}
op<-par(mfrow=c(1,1), mar=c(0,0,0,0))
# index order
