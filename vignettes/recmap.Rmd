...
check on how computer-generated rectangular cartograms could look like. 
This R package provides a rectangular cartogram algorithm to be used by any 
R user. Now, it is easy to generate input (e.g, no complex polygon mesh), 
the code is maintainable, and the algorithm is made robust 
