...
given statistival values. These so-called cartograms or value-by-area-maps may 
...
(worst-case-szenario; is implemented but not possible to run in the current 
version)
...
and IV indicated by different colors in the gaphic below.
...
recmap:::.plot_recmap_error(Cartogram.ChessBoard)
...
- provide some examples for meta heutistics at the 
[RecMap Gallery](http://cartodraw.science/recmap/gallery/)
