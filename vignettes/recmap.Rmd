...
vignette: >
  %\VignetteIndexEntry{A quick tour of recmap}
...
- Place region by region along DFS skeleton of pseudo dual starting with the 
core region
...
to the price of not having all features implemented.
